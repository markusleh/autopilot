...
def make_env(env_id, idx, capture_video, run_name, gamma):
    def thunk():
        if capture_video and idx == 0:
            env = gym.make(env_id, render_mode="graph")
...
if __name__ == "__main__":
            ...
            if "final_info" in infos:
                for info in infos["final_info"]:
                    if info and "episode" in info:
                        ...
                        writer.add_scalar("info/mean_track_error", info["mean_track_error"], global_step)
                        writer.add_scalar("info/mean_altitude_error", info["mean_altitude_error"], global_step)
                        writer.add_scalar("info/max_force", info["max_force"], global_step)
    ...
    filehandler = open(f"models/{run_name}/obs.pickle","wb")
